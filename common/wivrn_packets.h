...
using packets = std::variant<headset_info_packet, feedback, audio_data, handshake, tracking, hand_tracking, fb_face2, inputs, timesync_response>;
} // namespace from_headset
